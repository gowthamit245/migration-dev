                  ...
                  <div class="row">
                      ...
                      <div class="col-md-5">
                          <div class="source">
                                  ...
                                  <table class="table mb-1" id="schema_list">
                                      <tbody>
                                          ...
                                          <tr class="<?php if($row['status'] == 1){ echo 'selected'; }?>">
                                              <td onclick="source_selected(<?= $row['id'] ?> );"><?= $row['snow_flake'] ?></td>
                                          </tr>
                                          <?php } ?>
                                      </tbody>
                                  </table>
                              ...
                              <a  class="text-decoration-none btn bg-087486 text-light" href="<?php echo base_url();?>migration-process/<?php echo $this->session->userdata('job_id'); ?>">
                                  Next </a>
                          </div>
                            ...
                            success:function(result){
                                 ...
                                 for(var i=0;i<d.length;i++)
                                 {
                                  ...
                                  data+='<div class="col">'+d[i].hosturl+'</div>';
                                   ...
                                   data+='<div class="col"><a href="'+weblink+'schema-list/'+d[i].database_id+'" class="btn btn-success">Connect</a></div>';
                                   data+='</div>';
                                 }
                                 $("#parent").html(data);
                              console.log(result);
